...
> Part of the **Tollcraft** initiative, funded by Drips Wave 7.
...
This tool acts as the preventative shield in the Tollcraft two-tiered cost pipeline, pairing conceptually with our runtime test harness, [`soroban-budget-assert`](https://github.com/your-org/soroban-budget-assert).
