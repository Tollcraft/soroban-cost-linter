...
| [`event_in_loop`](../docs/lints/event_in_loop.md) | Detects `env.events().publish(...)` (and similar) calls inside loop bodies, where each emission charges CPU and bloats the transaction footprint. |
